...
write_csv(sens_spec_all %>% filter(dvar == "pcr_prev", dcutoff == 0, var == "pgp3_prev") %>% 
            ...
            dplyr::select("Seroprevalence threshold (%)" = cutoff,
                          "Sensitivity" = sens,
                          "Specificity" = spec),
          file = here("output", "trachoma-transmission-serology-tableS2_sens_spec_sp.csv"))
...
threshold (no seroreversion)" = cutoff,
                          "Sensitivity" = sens,
                          "Specificity" = spec),
          file = here("output", "trachoma-transmission-serology-tableS3_sens_spec_scr.csv"))
...
write_csv(sens_spec_1to5 %>% filter(dvar == "pcr_prev", dcutoff == 0, var == "pgp3_prev") %>% 
            ...
            dplyr::select("Seroprevalence threshold (%)" = cutoff,
                          "Sensitivity" = sens,
                          "Specificity" = spec),
          file = here("output", "trachoma-transmission-serology-tableS4_sens_spec_sp_1to5.csv"))
...
threshold (no seroreversion)" = cutoff,
                          "Sensitivity" = sens,
                          "Specificity" = spec),
          file = here("output", "trachoma-transmission-serology-tableS5_sens_spec_scr_1to5.csv"))
```
